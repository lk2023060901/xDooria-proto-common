...
const (
	// 默认值，无特殊标志
	MessageFlags_MESSAGE_FLAGS_NONE MessageFlags = 0
	// 加密消息
	MessageFlags_MESSAGE_FLAGS_ENCRYPTED MessageFlags = 16
	// 压缩消息
	MessageFlags_MESSAGE_FLAGS_COMPRESSED MessageFlags = 32
)
...
var (
	MessageFlags_name = map[int32]string{
		...
		16: "MESSAGE_FLAGS_ENCRYPTED",
		32: "MESSAGE_FLAGS_COMPRESSED",
	}
	MessageFlags_value = map[string]int32{
		"MESSAGE_FLAGS_NONE":       0,
		"MESSAGE_FLAGS_ENCRYPTED":  16,
		"MESSAGE_FLAGS_COMPRESSED": 32,
	}
)
...
func (x *MessageHeader) GetSeqId() uint32 {
	if x != nil {
		return x.SeqId
	}
	return 0
...
const file_envelope_proto_rawDesc = "" +
	...
	"\x06seq_id\x18\x02 \x01(\rR\x05seqId\x12\x12\n" +
	"\x04size\x18\x03 \x01(\rR\x04size\x12\x14\n" +
	"\x05flags\x18\x04 \x01(\rR\x05flags\x12\x12\n" +
	"\x04sign\x18\x05 \x01(\fR\x04sign\x12\x1c\n" +
	"\ttimestamp\x18\x06 \x01(\x04R\ttimestamp\"S\n" +
	"\bEnvelope\x12-\n" +
	...
	"\x12MESSAGE_FLAGS_NONE\x10\x00\x12\x1b\n" +
	"\x17MESSAGE_FLAGS_ENCRYPTED\x10\x10\x12\x1c\n" +
	"\x18MESSAGE_FLAGS_COMPRESSED\x10 B5Z3github.com/lk2023060901/xdooria-proto-common;commonb\x06proto3"
